              ...
              <div class="ibox float-e-margins">
                ...
                <div class="ibox-content no-padding">
                  <ul class="list-group">
                    <li class="list-group-item">
                      <p><a class="text-info"
                            href="index.html#">@Alan Marry</a> I belive that. Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                      </p>
                      <small class="block text-muted"><i class="fa fa-clock-o"></i> 1 minuts ago</small>
                    </li>
                    <li class="list-group-item">
                      <p><a class="text-info"
                            href="index.html#">@Stock Man</a> Check this stock chart. This price is crazy! </p>
                    ...
                    <li class="list-group-item">
                      <p><a class="text-info"
                            href="index.html#">@Kevin Smith</a> Lorem ipsum unknown printer took a galley </p>
                      <small class="block text-muted"><i class="fa fa-clock-o"></i> 2 minuts ago</small>
                    </li>
                    <li class="list-group-item ">
                      <p><a class="text-info" href="index.html#">@Jonathan Febrick</a> The standard chunk of Lorem Ipsum
                      </p>
            ...
            <div class="col-lg-4">
              <div class="ibox float-e-margins">
                ...
                <div class="ibox-content ibox-heading">
                  ...
                  <small><i class="fa fa-map-marker"></i> Meeting is on 6:00am. Check your schedule to see detail.
                  </small>
                </div>
...
<script>
  export default {
    ...
    mounted() {
      ...
      $("#flot-dashboard-chart").length && $.plot(
